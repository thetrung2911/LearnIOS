...
class CenterView: UIView {
    ...
    func setupView(){
        kungPaoLabel.text = "Kung Pao Potato"
        
        lunchLabel.text = "Lunch Box"
        lunchLabel.font = UIFont.systemFont(ofSize: 13)
        lunchLabel.textColor = .lightGray
        
        midldlyLabel.text = "Middly spiced indian buttermilk with mint flavor"
        ...
        homeLabel.text = "Home (B 701, sunder nagar, malad ...)"
