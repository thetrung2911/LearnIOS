    ...
    func setupData(){
        sections = [
            Section(title: "Dynamic",
                    menu: [
                        Menu(title: "BallFallsTimer", identifier: "BallFallsTimer"),
                        Menu(title: "BallFallsAnimate", identifier: "BallFallsAnimate"),
                        Menu(title: "DropVC", identifier: "DropVC"),
                        Menu(title: "DropArcVC", identifier: "DropArcVC")
                        ])
        ]
    }
}
