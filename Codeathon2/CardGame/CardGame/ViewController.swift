    ...
    func updateUIFromModel() {
        for i in buttons.indices {
            ...
            if card.isFaceUp {
                ...
                button.backgroundColor = card.isMatched ? #colorLiteral(red: 0.3411764801, green: 0.6235294342, blue: 0.1686274558, alpha: 1) : #colorLiteral(red: 1, green: 0.5763723254, blue: 0, alpha: 1)
            }
        }
    }
